				...
				<Card>
					...
					<CardFooter active>
						<View style={styles.homePageAlignCenter}>
							...
							<View style={styles.homePageCategoryDescriptionContainer} />

							<View style={styles.homePageCategoryDescriptionWrapper}>
								{typeof(this.props.vehicle.description) === 'object' ?
